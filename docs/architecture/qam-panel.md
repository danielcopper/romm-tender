...
2. **Library** ([#1815](https://github.com/danielcopper/romm-tender/issues/1815)) — Platforms and Collections; System
   ...
   Platforms detail instead of the retired System page. **Landed**: Platforms (#1836), then Collections
   ([#1833](https://github.com/danielcopper/romm-tender/issues/1833)) in three code PRs — the backend's in-Steam count
   and owner name, the page as list and detail over the kinds, and the Steam-name suffixes that follow the kinds' names.
