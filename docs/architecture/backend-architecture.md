...
| `retroarch_core_info.py`                                                   | `RetroArchCoreInfoAdapter` — reads RetroArch `.info` files (`corename`, metadata); no service consumes it                                                                                                                                                                                                                                                                                                                                      |
...
| **MigrationService**        | `MigrationFileStore`, `RetroDeckPaths`, `RelaunchOptionsReader`, `FirmwareResolver` (which files in a pending home are firmware)                                                                                                                                                                                                                                                                                                                                                                                                    |
