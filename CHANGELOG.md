...
## [1.0.0](https://github.com/danielcopper/romm-tender/compare/tender-v0.33.0...tender-v1.0.0) (2026-09-26)


### ⚠ BREAKING CHANGES

* **connection:** Tender requires RomM 5.3.0 or newer; older servers are refused at connect.

### Features

* **collections:** name standard collections without a suffix under by_label ([#2033](https://github.com/danielcopper/romm-tender/issues/2033)) ([49d2892](https://github.com/danielcopper/romm-tender/commit/49d2892400c18190ad7e498e1ae976c5f3929d97)), closes [#1833](https://github.com/danielcopper/romm-tender/issues/1833)
* **connection:** require RomM 5.3.0 ([#2006](https://github.com/danielcopper/romm-tender/issues/2006)) ([c3b93f0](https://github.com/danielcopper/romm-tender/commit/c3b93f0d086038748f84aa1c42cb3fc86d04925d))
...
* **gamepage:** put Tender's section on Steam's game page through a seam of its own ([#1968](https://github.com/danielcopper/romm-tender/issues/1968)) ([449a943](https://github.com/danielcopper/romm-tender/commit/449a9430e6badd4ffe748354435ab6053b32b453)), closes [#1944](https://github.com/danielcopper/romm-tender/issues/1944)
...
* **inject:** reload steam's js context when an earlier backend's panel is still loaded ([#2038](https://github.com/danielcopper/romm-tender/issues/2038)) ([8f53704](https://github.com/danielcopper/romm-tender/commit/8f53704872061eb5b5a2dbb6dd7c4d59da4830e8)), closes [#2009](https://github.com/danielcopper/romm-tender/issues/2009)
...
* **install:** one-line installer, user unit, XDG layout ([#1969](https://github.com/danielcopper/romm-tender/issues/1969)) ([73d7771](https://github.com/danielcopper/romm-tender/commit/73d7771770c69ea87845d9062be6800c2b8dcf17)), closes [#1902](https://github.com/danielcopper/romm-tender/issues/1902)
* **library:** forward each collection's in-Steam count and owner name ([#1994](https://github.com/danielcopper/romm-tender/issues/1994)) ([25001f4](https://github.com/danielcopper/romm-tender/commit/25001f489550d92d06c0c23caef241204f9653dc)), closes [#1833](https://github.com/danielcopper/romm-tender/issues/1833)
* **qam:** list the collection kinds with their collections beside them ([#2002](https://github.com/danielcopper/romm-tender/issues/2002)) ([d47ef68](https://github.com/danielcopper/romm-tender/commit/d47ef683ab3193daa7aee44641feaca9218dbe4f)), closes [#1833](https://github.com/danielcopper/romm-tender/issues/1833) [#1020](https://github.com/danielcopper/romm-tender/issues/1020)
* **qam:** make Data Management an inventory of what this device holds ([#1977](https://github.com/danielcopper/romm-tender/issues/1977)) ([1098819](https://github.com/danielcopper/romm-tender/commit/1098819d4793d146fdd762c48f80635f63244269)), closes [#1817](https://github.com/danielcopper/romm-tender/issues/1817)
* **qam:** mount Tender's panel behind its own Quick Access entry ([#1946](https://github.com/danielcopper/romm-tender/issues/1946)) ([6af1586](https://github.com/danielcopper/romm-tender/commit/6af1586124ebc3a38733cceb6b7913dbf50ebef2)), closes [#1942](https://github.com/danielcopper/romm-tender/issues/1942)
* **qam:** redraw the removed-games review so its controls are within reach ([#1986](https://github.com/danielcopper/romm-tender/issues/1986)) ([ec9fef7](https://github.com/danielcopper/romm-tender/commit/ec9fef784decb2243021f7f8d39568b9318c7f0e)), closes [#1817](https://github.com/danielcopper/romm-tender/issues/1817)
* **release:** the tarball and its checksum ship with every release ([#1975](https://github.com/danielcopper/romm-tender/issues/1975)) ([9ff3c06](https://github.com/danielcopper/romm-tender/commit/9ff3c064688f19100222e6c73ffd8133f87b9d17)), closes [#1904](https://github.com/danielcopper/romm-tender/issues/1904)
* **saves:** take the save directory from the resolver and follow it when it moves ([#2005](https://github.com/danielcopper/romm-tender/issues/2005)) ([89ea4ed](https://github.com/danielcopper/romm-tender/commit/89ea4ed0150be5b6d1aec18004b73d50ca80d9d1)), closes [#1660](https://github.com/danielcopper/romm-tender/issues/1660) [#1811](https://github.com/danielcopper/romm-tender/issues/1811)
* **toasts:** raise toasts through Steam's own notification store ([#1953](https://github.com/danielcopper/romm-tender/issues/1953)) ([259aa99](https://github.com/danielcopper/romm-tender/commit/259aa99d8807f68bd5d7f95c91bc7bd98571300d)), closes [#1943](https://github.com/danielcopper/romm-tender/issues/1943)
* **update:** check for a newer release and show it in the panel ([#2028](https://github.com/danielcopper/romm-tender/issues/2028)) ([c53ad5a](https://github.com/danielcopper/romm-tender/commit/c53ad5ab13176d901899e9d010098a668a4c40bc)), closes [#2010](https://github.com/danielcopper/romm-tender/issues/2010)
...
* **host:** unmask a websocket payload in one pass instead of per byte ([#2020](https://github.com/danielcopper/romm-tender/issues/2020)) ([a75eab8](https://github.com/danielcopper/romm-tender/commit/a75eab8261f6a5e40057367ae7804a16627d2495))
* **inject:** call the globals installer before loading the panel ([#1965](https://github.com/danielcopper/romm-tender/issues/1965)) ([1c85d2c](https://github.com/danielcopper/romm-tender/commit/1c85d2c94602a8518d0e69f2649f198f327b62e8)), closes [#1958](https://github.com/danielcopper/romm-tender/issues/1958) [#1964](https://github.com/danielcopper/romm-tender/issues/1964)
* **install:** the piped run mislays the greeter and the rows, and a backend outside the service goes unnoticed ([#1980](https://github.com/danielcopper/romm-tender/issues/1980)) ([abda748](https://github.com/danielcopper/romm-tender/commit/abda748d9d9c6062e73b168651d99a2e57951734)), closes [#1976](https://github.com/danielcopper/romm-tender/issues/1976)
* **logging:** record a frontend log line at the level its caller named ([#1956](https://github.com/danielcopper/romm-tender/issues/1956)) ([b5ab0a5](https://github.com/danielcopper/romm-tender/commit/b5ab0a57ce089afe61f8f58acfcc7db1a3ebfaf0)), closes [#1954](https://github.com/danielcopper/romm-tender/issues/1954)
* **qam:** answer the QAM's visibility where no navigation tree exists ([#1970](https://github.com/danielcopper/romm-tender/issues/1970)) ([4553861](https://github.com/danielcopper/romm-tender/commit/45538616eb4a2ef91ff5e7e307ef0dd2bc4127de)), closes [#1948](https://github.com/danielcopper/romm-tender/issues/1948)
* **qam:** judge a focusable row by what Steam's nav node reads ([#1972](https://github.com/danielcopper/romm-tender/issues/1972)) ([72a855b](https://github.com/danielcopper/romm-tender/commit/72a855b1dcf7be156a37fb86dd456ea2474507c8)), closes [#1930](https://github.com/danielcopper/romm-tender/issues/1930)
* **qam:** keep the focus ring's room in every scroll region ([#1982](https://github.com/danielcopper/romm-tender/issues/1982)) ([5e13dc0](https://github.com/danielcopper/romm-tender/commit/5e13dc010801374bf6b1d35098b2ae530f0497e0)), closes [#1981](https://github.com/danielcopper/romm-tender/issues/1981)
* **qam:** keep the grid images count honest after a removal ([#1985](https://github.com/danielcopper/romm-tender/issues/1985)) ([c86339f](https://github.com/danielcopper/romm-tender/commit/c86339ff5ea729b2af4388724250dae3b41ea23f)), closes [#1817](https://github.com/danielcopper/romm-tender/issues/1817)
* **qam:** name the set the BIOS held ratio counts over ([#1971](https://github.com/danielcopper/romm-tender/issues/1971)) ([0a81e75](https://github.com/danielcopper/romm-tender/commit/0a81e75c992f55af20315f7dd6aa6f33f25a7564)), closes [#1910](https://github.com/danielcopper/romm-tender/issues/1910)
...
* six small backend fixes — atomic retroarch.cfg write, 0600 settings backup, and four more ([#2049](https://github.com/danielcopper/romm-tender/issues/2049)) ([77464c0](https://github.com/danielcopper/romm-tender/commit/77464c027994bd3faec40b5934bfe9d0396ab505)), closes [#1871](https://github.com/danielcopper/romm-tender/issues/1871) [#1166](https://github.com/danielcopper/romm-tender/issues/1166) [#941](https://github.com/danielcopper/romm-tender/issues/941) [#1016](https://github.com/danielcopper/romm-tender/issues/1016) [#1132](https://github.com/danielcopper/romm-tender/issues/1132) [#810](https://github.com/danielcopper/romm-tender/issues/810)
...
* **ui:** eight small fixes — the game's own BIOS answer, slow Steam entries keep their binding, Manual archive, and five more ([#2053](https://github.com/danielcopper/romm-tender/issues/2053)) ([c6442ca](https://github.com/danielcopper/romm-tender/commit/c6442ca3b3d11e412a8b47188a9979b47f3ceb76))
