...
home is derived from the data root this run was told about, and whether the
...
class ShortcutLauncher:
    ...
    that home. Where the write failed, it is the copy the release ships beside
    the program, which is where every shortcut pointed before the move and still
    works. The third case
