 ...
 * resolves it on the next input — onto whatever sits at the old page's position
 * — so a newly mounted body has to claim focus itself. Three callers do, on the
 * same delay: the wide-page frame for its own body
 ...
 * the panel's router (`frontend/src/index.tsx`) for the narrow pages, and the
 * wide-page frame (`frontend/src/bigpicture/layout/WidePage.tsx`) for its own
 * body.
 *
 ...
 *
 * A list-and-detail page (`bigpicture/layout/ListDetail.tsx`) declares on its
