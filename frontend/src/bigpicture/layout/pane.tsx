 ...
 * (`@decky/ui/dist/components/Dialog.js`,
 * `DialogButton = DialogButtonSecondary`). So `ButtonItem` IS a `Field` wrapped
 * around this component, and what a `Field` costs is the row's own padding:
 * 10px top and bottom inside the QAM, where it renders in its `Classic` mode.
 */
