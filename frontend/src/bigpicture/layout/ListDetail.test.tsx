 ...
 *
 * The @decky/ui stub in `frontend/src/test-setup.ts` renders every Focusable as
 * a div that forwards onFocus, so focus moving onto a row is driven with a real
